...
var o22691 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22691["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22692 = temp__5455__auto____$1;
return (o22692["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21772__auto__ = f;
return (o__21772__auto__["toString"]).call(o__21772__auto__);
} else {
return "";
}
}catch (e22693){var _ = e22693;
return "";
}});
...
try{var o__21772__auto___22695 = t;
(o__21772__auto___22695["cljs$lang$ctorPrWriter"]).call(o__21772__auto___22695,t,writer);
}catch (e22694){var __22696 = e22694;
}
...
var char_code = (function (){var o__21772__auto__ = (new String(char$));
return (o__21772__auto__["charCodeAt"]).call(o__21772__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21772__auto__ = String;
return (o__21772__auto__["fromCharCode"]).call(o__21772__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22697 = num_code;
switch (G__22697) {
case (1):
return (185);
...
var o__21772__auto__ = String;
return (o__21772__auto__["fromCharCode"]).call(o__21772__auto__,superscript_code);
});
/**
...
}catch (e22699){var _e__21779__auto__ = e22699;
return false;
}})())){
...
var vec__22700 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22700,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22703 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22703["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22704 = temp__5455__auto____$1;
return (o22704["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22707){
var vec__22708 = p__22707;
var ns_detector = cljs.core.nth.call(null,vec__22708,(0),null);
...
var G__22714 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22715 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22714;
remaining_tokens = G__22715;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22705){
var G__22706 = cljs.core.first.call(null,seq22705);
var seq22705__$1 = cljs.core.next.call(null,seq22705);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22706,seq22705__$1);
});
...
var vec__22719 = cljs.core.split_with.call(null,(function (p1__22718_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22718_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22719,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22719,(1),null);
...
var vec__22722 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22722,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22722,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22725 = cljs.core.rest.call(null,remaining_tokens);
var G__22726 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22725;
name_tokens = G__22726;
continue;
} else {
...
var vec__22729 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22729,(0),null);
var arity = cljs.core.nth.call(null,vec__22729,(1),null);
var vec__22732 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22732,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22732,(1),null);
var vec__22735 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22735,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22735,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22735,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22735,(3),null);
...
var vec__22741 = result;
var munged_ns = cljs.core.nth.call(null,vec__22741,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22741,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22741,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22741,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22741,(4),null);
var arity = cljs.core.nth.call(null,vec__22741,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22745 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22745,(0),null);
var args = cljs.core.nth.call(null,vec__22745,(1),null);
var vec__22748 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__22751 = (arity + (1));
var G__22752 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22753){
var vec__22754 = p__22753;
var arity = cljs.core.nth.call(null,vec__22754,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22754,(1),null);
...
return cljs.core.get.call(null,arities,p1__22757_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22758_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22761){
var vec__22762 = p__22761;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22762,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22759){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22770__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22770__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22770__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22770__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22771 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22771,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22771,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22771,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22771,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22771,(4),null);
var arity = cljs.core.nth.call(null,vec__22771,(5),null);
...
var o__21772__auto__ = f;
return (o__21772__auto__["getBasis"]).call(o__21772__auto__);
});
/**
...
}catch (e22775){var _e__21779__auto__ = e22775;
...
var G__22776 = (obj[cljs.core.first.call(null,path)]);
var G__22777 = cljs.core.rest.call(null,path);
obj = G__22776;
path = G__22777;
continue;
} else {
...
return (function (accum,p__22778){
var vec__22779 = p__22778;
var bit = cljs.core.nth.call(null,vec__22779,(0),null);
var protocol = cljs.core.nth.call(null,vec__22779,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22782){
var vec__22783 = p__22782;
var ns = cljs.core.nth.call(null,vec__22783,(0),null);
var name = cljs.core.nth.call(null,vec__22783,(1),null);
var selector = cljs.core.nth.call(null,vec__22783,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22788,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22788,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22788,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22786_SHARP_){
return (obj[cljs.core.first.call(null,p1__22786_SHARP_)]);
});})(name,sorted_matches,vec__22788,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1552095700849
