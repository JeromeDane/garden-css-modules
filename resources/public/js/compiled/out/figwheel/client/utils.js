...
return (new CustomEvent(event_name,(function (){var obj28515 = {"detail":data};
return obj28515;
})()));
} else {
...
var f = (function (){var pred__28522 = cljs.core._EQ_;
var expr__28523 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28522.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28523))){
return ((function (pred__28522,expr__28523){
return (function (p1__28516_SHARP_){
return console.warn(p1__28516_SHARP_);
});
;})(pred__28522,expr__28523))
} else {
if(cljs.core.truth_(pred__28522.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28523))){
return ((function (pred__28522,expr__28523){
return (function (p1__28517_SHARP_){
return console.debug(p1__28517_SHARP_);
});
;})(pred__28522,expr__28523))
} else {
if(cljs.core.truth_(pred__28522.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28523))){
return ((function (pred__28522,expr__28523){
return (function (p1__28518_SHARP_){
return console.error(p1__28518_SHARP_);
});
;})(pred__28522,expr__28523))
} else {
return ((function (pred__28522,expr__28523){
return (function (p1__28519_SHARP_){
return console.log(p1__28519_SHARP_);
});
;})(pred__28522,expr__28523))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28526){
...
var opts = map__28527__$1;
var eval_fn = cljs.core.get.call(null,map__28527__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28529_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28531,(0),null);
...
}catch (e28536){if((e28536 instanceof Error)){
var e = e28536;
return not_found;
} else {
throw e28536;
...
//# sourceMappingURL=utils.js.map?rel=1552095709502
