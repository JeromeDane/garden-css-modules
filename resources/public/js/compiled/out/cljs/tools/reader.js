...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24727 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24727,ch);
...
if(("\\" === ch__$1)){
var ch_24728__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24728__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24728__$2);
} else {
}
...
var vec__24737 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24737,(0),null);
var start_column = cljs.core.nth.call(null,vec__24737,(1),null);
...
var G__24740 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24740;
continue;
}
}
...
var _STAR_read_delim_STAR_24741 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24741;
}});
/**
...
var vec__24745 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24745,(0),null);
var end_column = cljs.core.nth.call(null,vec__24745,(1),null);
...
var sb = (function (){var G__24760 = (new goog.string.StringBuffer());
G__24760.append(initch);
...
var G__24762 = (function (){var G__24761 = sb;
G__24761.append(ch);

return G__24761;
})();
var G__24763 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24762;
ch = G__24763;
continue;
}
...
switch (G__24766) {
case "\\":
var G__24770 = (function (){var G__24767 = sb;
G__24767.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24767;
})();
var G__24771 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24770;
ch = G__24771;
continue;
...
break;
default:
var G__24772 = (function (){var G__24768 = sb;
G__24768.append(ch);

return G__24768;
})();
var G__24773 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24772;
ch = G__24773;
continue;
...
var line = cljs.core.nth.call(null,vec__24777,(0),null);
var column = cljs.core.nth.call(null,vec__24777,(1),null);
...
var line = cljs.core.nth.call(null,vec__24782,(0),null);
var column = cljs.core.nth.call(null,vec__24782,(1),null);
...
var vec__24787 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__24792 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__24795 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24795,(0),null);
var end_column = cljs.core.nth.call(null,vec__24795,(1),null);
...
var G__24798 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24798,true,null,opts,pending_forms);
...
var G__24799 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24799)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24799)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24799)){
...
var _STAR_suppress_read_STAR_24800 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24800;
}});
...
var G__24801 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24801,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24801,rdr,first_line);
...
var G__24806 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24805;
finished = G__24806;
continue;
} else {
...
var _STAR_suppress_read_STAR_24807 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24807;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24808 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24809 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24809,"(");
...
var G__24810 = (i + (1));
var G__24811 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24808;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24812 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24812);
...
var G__24813 = cljs.core.next.call(null,s__$1);
var G__24814 = ret;
s__$1 = G__24813;
r = G__24814;
continue;
...
var G__24815 = cljs.core.next.call(null,s);
var G__24816 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24815;
key_vals = G__24816;
continue;
} else {
...
var gensym_env24820 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24820;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24821 = token;
var G__24821__$1 = (((G__24821 == null))?null:cljs.core.subs.call(null,G__24821,(1)));
var G__24821__$2 = (((G__24821__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24821__$1));
var G__24821__$3 = (((G__24821__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24821__$2));
var G__24821__$4 = (((G__24821__$3 == null))?null:cljs.core.symbol.call(null,G__24821__$3));
if((G__24821__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24821__$4);
}
})():(function (){var G__24822 = token;
var G__24822__$1 = (((G__24822 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24822));
if((G__24822__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24822__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24833,reader){
...
var eof = cljs.core.get.call(null,map__24834__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24840){
var G__24841 = cljs.core.first.call(null,seq24840);
var seq24840__$1 = cljs.core.next.call(null,seq24840);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24841,seq24840__$1);
});


//# sourceMappingURL=reader.js.map?rel=1552095706037
